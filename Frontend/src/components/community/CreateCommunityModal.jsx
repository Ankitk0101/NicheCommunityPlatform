...
import { X, Upload, Image, Hash } from 'lucide-react';

const CreateCommunityModal = ({ community, onClose, onSubmit, categories }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (community) {
        await onSubmit(community._id, submitData);
      } else {
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      // This would typically upload to Cloudinary or your server
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex space-x-4 pt-4">
            ...
            >
              {uploading ? 'Creating...' : community ? 'Update Community' : 'Create Community'}
            </button>
          </div>
        </form>
      </motion.div>
