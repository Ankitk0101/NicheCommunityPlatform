    ...
    <footer className="bg-white border-t border-gray-200 mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-sm font-semibold text-gray-900 mb-4">NicheConnect</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Communities</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Discussions</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Events</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Resources</a></li>
            </ul>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-600">© 2025 NicheConnect. All rights reserved.</p>
